...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 py-8 px-4 sm:py-16">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4 animate-fade-in">
            Argonath
          </h1>
          <p className="text-lg sm:text-xl text-gray-300 animate-fade-in-delayed">
        ...
        <div className="relative max-w-md mx-auto">
          ...
          <button
            onClick={prevCard}
            className="hidden sm:block absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 bg-gray-800 dark:bg-gray-700 text-white p-2 rounded-full shadow-lg hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 z-10 transform transition-transform hover:scale-110"
          ...
          <button
            onClick={nextCard}
            className="hidden sm:block absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 bg-gray-800 dark:bg-gray-700 text-white p-2 rounded-full shadow-lg hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 z-10 transform transition-transform hover:scale-110"
              ...
              return (
                ...
                >
                  <div
                    ...
                    className="bg-gray-800 dark:bg-gray-700 rounded-xl shadow-xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
                  >
                    {/* Card Header */}
                    <div
                      className={`bg-gradient-to-r ${tool.color} p-6 relative overflow-hidden`}
                    >
                      <div className="absolute inset-0 bg-black/10 backdrop-blur-lg opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 flex justify-center">
                        <span className="inline-flex items-center text-sm text-blue-400 font-medium hover:text-blue-300 transition-colors">
                          Get Started
